...
export function UnifiedAlertsPanel() {
    ...
    const [showAircraftTracks, setShowAircraftTracks] = useState(false);
    ...
    const { data: aircraftData, isLoading: aircraftLoading } = useAircraftTracks(enabled && showAircraftTracks && alertMode === 'emergency');
    ...
    const { trackCount } = useAircraftLayer({
        enabled: enabled && showAircraftTracks && alertMode === 'emergency',
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10 shadow-xl">
                ...
                {enabled && (
                    <>
                        ...
                        {alertMode === 'emergency' && showAircraftTracks && (
                            <div className="mt-2 flex items-center justify-between text-[10px] text-white/60 bg-black/10 p-2 rounded-lg">
                                <span>Aircraft Tracks</span>
                                <span className="font-mono">{aircraftLoading ? '...' : trackCount}</span>
                            </div>
                        )}
                    </>
                )}
            ...
            {enabled && alertMode === 'emergency' && (
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10 shadow-xl">
                    ...
                    {/* Aircraft Tracks */}
                    <div className="mb-4 flex items-center justify-between bg-black/20 p-3 rounded-lg">
                        <div>
                            <p className="text-xs text-white/70">Live Aircraft Tracks</p>
                            <p className="text-[10px] text-white/40">ADSB registry filtered</p>
                        </div>
                        <Switch checked={showAircraftTracks} onCheckedChange={setShowAircraftTracks} />
                    </div>
