...
This folder is a self-contained plugin bundle for the AU police + emergency services alerts system. It is designed to be map-system agnostic and portable to MapLibre, MapTiler, ArcGIS JS, Google Maps, Cesium, or any platform capable of rendering GeoJSON.

## What This Bundle Contains
- `code/` - copied source files with original paths preserved
...
A MapLibre-compatible aircraft tracks layer hook is included:
`code/client/src/hooks/useAircraftLayer.ts`
It renders live ADSB tracks when enabled in the Alerts panel.
