...
### UI + Map Layers
- `AlertsSidebar` controls mode (emergency/police), filters, heatmap.
...
4. Core rule: when terrain or hillshade is enabled, prevent vertical shift during pan while allowing normal pitch/bearing changes outside of pan.
